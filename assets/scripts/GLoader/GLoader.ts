...
//         if (res) return;
//         this.getBundle(resArgs.type, (bundle: cc.AssetManager.Bundle) => {
//             this.__nLoadRef++;
//             bundle.load(resArgs.url, resArgs.type, resArgs.onProgess, (err, res) => {
//                 //cc.error("find statis file" + resArgs.url);
//                 if (!err) {
...
//     public getBundle(type: typeof cc.Asset, callBack: (bundle: cc.AssetManager.Bundle) => void) {
//         let bundleName = "";
//         if (type == cc.SpriteAtlas || type == cc.SpriteFrame) {
//             bundleName = JXDef.bundle.texture;
//         } else if (type == sp.SkeletonData) {
//             bundleName = JXDef.bundle.spine;
//         } else if (type == cc.JsonAsset || type == cc.TextAsset) {
