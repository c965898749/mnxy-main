...
@ccclass('HolPromptEqMessage')
export class HolPromptEqMessage extends Component {
    // 内容状态 0 开始 1 持续 2关闭
    private $state = 0
    ...
    setContent(option: PromptMessageOption) {
        // 设置游戏内容
        this.node.getChildByName("Message").getComponent(RichText).string = option.message
        // 设置状态开始
        this.$state = 0
        // 初始状态
