...
export function GetCharacterCoordinatePosition(
    ...
    result.x = 170 - (type === "attack" ? 120 : 0)
    result.y = -70
...
export class HolCharacter extends Component {
     ...
     * create 是角色创建数据
     */
    async initCharacter(create: CharacterStateCreate, direction: "left" | "right", fightMap: FightMap = null) {
        // 创建角色状态
        ...
        await this.$holAnimation.initBones({
            ...
            avatarPath: this.state.meta.AvatarPath
        })
