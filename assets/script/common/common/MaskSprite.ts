// import { _decorator, Enum, RenderComponent, size, SpriteFrame, Vec2 } from "cc";
...
// const CARD_SIZE = size(97, 203);

// @ccclass @menu('FrameEx/MaskSprite')
// export default class MaskSprite extends RenderComponent {

//     @property(SpriteFrame) _spriteFrame: SpriteFrame = null;
//     @property({ type: SpriteFrame })
//     public get spriteFrame(): SpriteFrame { return this._spriteFrame; }
...
//     @property({ type: Enum(MaskSpriteType) }) _maskType: MaskSpriteType = MaskSpriteType.Square;
//     @property({ type: Enum(MaskSpriteType) })
...
//     @property(Vec2) _c: Vec2 = Vec2.ZERO
//     @property({
//         tooltip: CC_DEV && "绝对坐标下的中心点，针对的是纹理",
//     })
//     public get center(): Vec2 { return this._c };
...
//     @property(Vec2) _octParam: Vec2 = Vec2.ONE
//     @property({
...
//         }
//     })
//     public get octParam(): Vec2 { return this._octParam };
//     public set octParam(value: Vec2) {
...
//     public setSprite(spriteFrame: SpriteFrame, type: MaskSpriteType, center: Vec2, radius: number, minOffset?: number, maxOffset?: number) {
...
//     onLoad() {
//         this.node.on(Node.EventType.ANCHOR_CHANGED, this.onTransfromChange, this);
//         // 设置默认材质
...
//         let nc = v2(nw * (0.5 - nax), ny * (0.5 - nay));
//         this._vertices = {
...
//         let segments = 64;
//         let deltaAngle = misc.degreesToRadians(360) / segments;
//         let curentAngle = 0;
//         let texture = this._spriteFrame.getTexture();
//         let texw = texture.width, texh = texture.height, ratio = texw / texh;
//         let tc = this.convertN2T(this._c, texw, texh);
...
//      * ==》就是cocos坐标系转换成纹理坐标系
//      */
//     private convertN2T(p: Vec2, width: number, height: number): Vec2 {
