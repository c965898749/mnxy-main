...
@ccclass('introduceBack2')
export class introduceBack2 extends Component {
    @property(Node)
    playerItemCount: Node = null;
    @property(Node)
    otherCount: Node = null;
    /**
     * 触摸条件
     */
    ...
    public _attrLevelUp() {
        ...
        var otherCount = Number(this.otherCount.getComponent(Label).string)
        ...
        this.otherCount.getComponent(Label).string = otherCount.toString()
    }
}
