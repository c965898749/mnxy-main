...
@RegisterCharacter({ id: "119" })
export class Character extends CharacterMetaState {

    name: string = "小夜明珠·青"

    AnimationDir: string = "game/fight_entity/character/119"


    AvatarPath: string = "game/texture/frames/hero/119/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/119/spriteFrame"
