...
@RegisterCharacter({ id: "125" })
export class Character extends CharacterMetaState {

    name: string = "吕洞宾"

    AnimationDir: string = "game/fight_entity/character/125"


    AvatarPath: string = "game/texture/frames/hero/125/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/125/spriteFrame"
