...
@RegisterCharacter({ id: "102" })
export class Character extends CharacterMetaState {

    name: string = "崆峒印"

    AnimationDir: string = "game/fight_entity/character/102"


    AvatarPath: string = "game/texture/frames/hero/102/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/102/spriteFrame"
  ...
  AnimationScale: number = 1
   ...
   position = 2
    ...
    introduce: string = "我是璀璨的崆峒印，可爱的合成材料，集齐5个就可以合成更高星级的卡牌哦。"
