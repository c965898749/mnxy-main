...
@RegisterCharacter({ id: "6" })
export class Character extends CharacterMetaState {

    name: string = "树妖"

    AnimationDir: string = "game/fight_entity/character/6"


    AvatarPath: string = "game/texture/frames/hero/6/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/6/spriteFrame"
