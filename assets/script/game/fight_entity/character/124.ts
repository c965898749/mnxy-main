...
@RegisterCharacter({ id: "124" })
export class Character extends CharacterMetaState {

    name: string = "中夜明珠·青"

    AnimationDir: string = "game/fight_entity/character/124"


    AvatarPath: string = "game/texture/frames/hero/124/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/124/spriteFrame"
