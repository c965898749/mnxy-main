...
@RegisterCharacter({ id: "1093" })
export class Character extends CharacterMetaState {

    name: string = "黄牙老象"

    AnimationDir: string = "game/fight_entity/character/1093"


    AvatarPath: string = "game/texture/frames/hero/1093/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/1093/spriteFrame"
  ...
  AnimationScale: number = 1
   ...
   position = 2
    ...
    青狮王协同 Lv1
    与青狮王在同 一队伍时，增加自身200点生命上限，50点攻击， 50点速度。
    `.replace(/ /ig, "")

    introduce: string = "虽然我牙齿黄，但不蛀牙。"
