...
@RegisterCharacter({ id: "132" })
export class Character extends CharacterMetaState {

    name: string = "少年王天君"

    AnimationDir: string = "game/fight_entity/character/132"


    AvatarPath: string = "game/texture/frames/hero/132/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/132/spriteFrame"
