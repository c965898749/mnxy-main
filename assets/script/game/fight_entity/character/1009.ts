...
@RegisterCharacter({ id: "1009" })
export class Character extends CharacterMetaState {

    name: string = "虾兵"

    AnimationDir: string = "game/fight_entity/character/1009"


    AvatarPath: string = "game/texture/frames/hero/1009/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/1009/spriteFrame"
