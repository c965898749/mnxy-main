...
@RegisterCharacter({ id: "106" })
export class Character extends CharacterMetaState {

    name: string = "幼年年兽"

    AnimationDir: string = "game/fight_entity/character/106"


    AvatarPath: string = "game/texture/frames/hero/106/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/106/spriteFrame"
  ...
  AnimationScale: number = 1
   ...
   position = 2
    ...
    introduce: string = "好可爱的红毛狮子狗。听说它是年兽的幼崽，平时喜欢吃糖果和玩耍。"
