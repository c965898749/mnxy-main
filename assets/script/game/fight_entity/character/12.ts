...
@RegisterCharacter({ id: "12" })
export class Character extends CharacterMetaState {

    name: string = "树苗小妖"

    AnimationDir: string = "game/fight_entity/character/12"


    AvatarPath: string = "game/texture/frames/hero/12/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/12/spriteFrame"
