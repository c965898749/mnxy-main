...
@RegisterCharacter({ id: "114" })
export class Character extends CharacterMetaState {

    name: string = "大夜明珠·青"

    AnimationDir: string = "game/fight_entity/character/114"


    AvatarPath: string = "game/texture/frames/hero/114/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/114/spriteFrame"
