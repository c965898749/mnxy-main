...
@RegisterCharacter({ id: "128" })
export class Character extends CharacterMetaState {

    name: string = "鸿钧老祖"

    AnimationDir: string = "game/fight_entity/character/128"


    AvatarPath: string = "game/texture/frames/hero/128/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/128/spriteFrame"
