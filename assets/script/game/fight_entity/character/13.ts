...
@RegisterCharacter({ id: "13" })
export class Character extends CharacterMetaState {

    name: string = "小树妖"

    AnimationDir: string = "game/fight_entity/character/13"


    AvatarPath: string = "game/texture/frames/hero/13/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/13/spriteFrame"
