...
@RegisterCharacter({ id: "120" })
export class Character extends CharacterMetaState {

    name: string = "中夜明珠·紫"

    AnimationDir: string = "game/fight_entity/character/120"


    AvatarPath: string = "game/texture/frames/hero/120/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/120/spriteFrame"
