...
@RegisterCharacter({ id: "7" })
export class Character extends CharacterMetaState {

    name: string = "银角妖"

    AnimationDir: string = "game/fight_entity/character/7"


    AvatarPath: string = "game/texture/frames/hero/7/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/7/spriteFrame"
