...
@RegisterCharacter({ id: "107" })
export class Character extends CharacterMetaState {

    name: string = "成年年兽"

    AnimationDir: string = "game/fight_entity/character/107"


    AvatarPath: string = "game/texture/frames/hero/107/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/107/spriteFrame"
