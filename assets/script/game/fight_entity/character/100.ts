...
@RegisterCharacter({ id: "100" })
export class Character extends CharacterMetaState {

    name: string = "女娲石"

    AnimationDir: string = "game/fight_entity/character/100"


    AvatarPath: string = "game/texture/frames/hero/100/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/100/spriteFrame"
  ...
  AnimationScale: number = 1
   ...
   position = 2
    ...
    introduce: string = "女娲石,这个上古时期流传下来的神器,拥有着强大的力量。满级素材可用于合成高级卡牌。"
