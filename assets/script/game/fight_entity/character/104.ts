...
@RegisterCharacter({ id: "104" })
export class Character extends CharacterMetaState {

    name: string = "切糕"

    AnimationDir: string = "game/fight_entity/character/104"


    AvatarPath: string = "game/texture/frames/hero/104/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/104/spriteFrame"
