...
@RegisterCharacter({ id: "8" })
export class Character extends CharacterMetaState {

    name: string = "金角妖"

    AnimationDir: string = "game/fight_entity/character/8"


    AvatarPath: string = "game/texture/frames/hero/8/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/8/spriteFrame"
