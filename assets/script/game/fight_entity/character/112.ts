...
@RegisterCharacter({ id: "112" })
export class Character extends CharacterMetaState {

    name: string = "大夜明珠·黄"

    AnimationDir: string = "game/fight_entity/character/112"


    AvatarPath: string = "game/texture/frames/hero/112/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/112/spriteFrame"
