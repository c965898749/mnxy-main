...
@RegisterCharacter({ id: "111" })
export class Character extends CharacterMetaState {

    name: string = "大夜明珠·蓝"

    AnimationDir: string = "game/fight_entity/character/111"


    AvatarPath: string = "game/texture/frames/hero/111/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/111/spriteFrame"
