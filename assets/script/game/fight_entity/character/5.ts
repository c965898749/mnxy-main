...
@RegisterCharacter({ id: "5" })
export class Character extends CharacterMetaState {

    name: string = "龟兵"

    AnimationDir: string = "game/fight_entity/character/5"


    AvatarPath: string = "game/texture/frames/hero/5/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/5/spriteFrame"
    ...
    introduce: string = "龟兵，大概是这部游戏里最让人讨厌的家伙了！擅长撞击、放冷箭，关键是敏捷度超高。"
