...
@RegisterCharacter({ id: "123" })
export class Character extends CharacterMetaState {

    name: string = "中夜明珠·红"

    AnimationDir: string = "game/fight_entity/character/123"


    AvatarPath: string = "game/texture/frames/hero/123/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/123/spriteFrame"
