...
@RegisterCharacter({ id: "129" })
export class Character extends CharacterMetaState {

    name: string = "蚩尤"

    AnimationDir: string = "game/fight_entity/character/129"


    AvatarPath: string = "game/texture/frames/hero/129/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/129/spriteFrame"
