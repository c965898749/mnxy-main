...
@RegisterCharacter({ id: "101" })
export class Character extends CharacterMetaState {

    name: string = "爱心雅安"

    AnimationDir: string = "game/fight_entity/character/101"


    AvatarPath: string = "game/texture/frames/hero/101/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/101/spriteFrame"
  ...
  AnimationScale: number = 1
   ...
   position = 2
    ...
    introduce: string = "地震带给雅安寒冷和黑暗，但是雅安，别怕。我们的爱心会温暖你们，赶走寒冷，点亮明天驱逐黑暗。"
