...
@RegisterCharacter({ id: "1097" })
export class Character extends CharacterMetaState {

    name: string = "赤精子"

    AnimationDir: string = "game/fight_entity/character/1097"


    AvatarPath: string = "game/texture/frames/hero/1097/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/1097/spriteFrame"
    ...
    广成子协同 Lv1
    与广成子在同一队伍时，增加自身200点生命上限，53点攻击，53点速度。
    `.replace(/ /ig, "")

    introduce: string = "十二金仙之一。"

    skillValue: string = `续命  广成子协同`
