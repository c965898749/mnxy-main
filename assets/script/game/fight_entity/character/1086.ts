...
@RegisterCharacter({ id: "1086" })
export class Character extends CharacterMetaState {

    name: string = "西海龙王"

    AnimationDir: string = "game/fight_entity/character/1086"


    AvatarPath: string = "game/texture/frames/hero/1086/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/1086/spriteFrame"
  ...
  AnimationScale: number = 1
   ...
   position = 2
    ...
    南海龙王协同 Lv{skillLv}
    与南海龙王在同 一队伍时，增加自身{healVal}点生命上限，{healVal2}点攻击， {healVal3}点速度。
    `.replace(/ /ig, "")

    introduce: string = "西海龙王敖闰是四海龙王之一。"

    skillValue: string = `灵力飞弹   南海龙王协同`
