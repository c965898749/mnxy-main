...
@RegisterCharacter({ id: "1078" })
export class Character extends CharacterMetaState {

    name: string = "巨灵神"

    AnimationDir: string = "game/fight_entity/character/1078"


    AvatarPath: string = "game/texture/frames/hero/1078/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/1078/spriteFrame"
