...
@RegisterCharacter({ id: "1070" })
export class Character extends CharacterMetaState {

    name: string = "太乙真人"

    AnimationDir: string = "game/fight_entity/character/1070"


    AvatarPath: string = "game/texture/frames/hero/1070/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/1070/spriteFrame"
  ...
  AnimationScale: number = 1
   ...
   position = 2
    ...
    普贤真人协同 Lv{skillLv}
    与普贤真人在同一队伍时，增加自身{healVal}点生命上限，{healVal2}点攻击，{healVal3}点速度。
    `.replace(/ /ig, "")

    introduce: string = "我是太乙，不是太2。"

    skillValue: string = `禁术咒  普贤真人协同`
