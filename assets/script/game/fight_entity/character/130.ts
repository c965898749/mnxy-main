...
@RegisterCharacter({ id: "130" })
export class Character extends CharacterMetaState {

    name: string = "通天教主"

    AnimationDir: string = "game/fight_entity/character/130"


    AvatarPath: string = "game/texture/frames/hero/130/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/130/spriteFrame"
