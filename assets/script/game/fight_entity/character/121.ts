...
@RegisterCharacter({ id: "121" })
export class Character extends CharacterMetaState {

    name: string = "中夜明珠·蓝"

    AnimationDir: string = "game/fight_entity/character/121"


    AvatarPath: string = "game/texture/frames/hero/121/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/121/spriteFrame"
