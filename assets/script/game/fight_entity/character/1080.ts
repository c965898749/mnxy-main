...
@RegisterCharacter({ id: "1080" })
export class Character extends CharacterMetaState {

    name: string = "琵琶精"

    AnimationDir: string = "game/fight_entity/character/1080"


    AvatarPath: string = "game/texture/frames/hero/1080/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/1080/spriteFrame"
  ...
  AnimationScale: number = 1
   ...
   position = 2
    ...
    混世魔王协同 lv1
    与混世魔王在同一队伍时，增加自身200点生命上限，50点攻击， 50点速度。
    `.replace(/ /ig, "")

    introduce: string = "琵琶精本是灵山脚下的蝎子精，因在如来听讲经时，不合时宜地蜇了如来佛祖一下，疼痛难忍的如来随即派金刚擒拿她。"
