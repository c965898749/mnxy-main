...
@RegisterCharacter({ id: "117" })
export class Character extends CharacterMetaState {

    name: string = "小夜明珠·黄"

    AnimationDir: string = "game/fight_entity/character/117"


    AvatarPath: string = "game/texture/frames/hero/117/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/117/spriteFrame"
