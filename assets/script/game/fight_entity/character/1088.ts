...
@RegisterCharacter({ id: "1088" })
export class Character extends CharacterMetaState {

    name: string = "南海龙王"

    AnimationDir: string = "game/fight_entity/character/1088"


    AvatarPath: string = "game/texture/frames/hero/1088/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/1088/spriteFrame"
  ...
  AnimationScale: number = 1
   ...
   position = 2
    ...
    东海龙王协同 Lv{skillLv}
    与东海龙王在同 一队伍时，增加自身{healVal}点生命上限，{healVal2}点攻击， {healVal3}点速度。
    `.replace(/ /ig, "")

    introduce: string = "西海龙王敖钦是四海龙王之一。"

    skillValue: string = `灵力飞弹   东海龙王协同`
