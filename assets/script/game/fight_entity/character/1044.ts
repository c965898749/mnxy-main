...
@RegisterCharacter({ id: "1044" })
export class Character extends CharacterMetaState {

    name: string = "鹿仁贾"

    AnimationDir: string = "game/fight_entity/character/1044"


    AvatarPath: string = "game/texture/frames/hero/1044/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/1044/spriteFrame"
  ...
  AnimationScale: number = 1
   ...
   position = 1
    ...
    introduce: string = "圣诞活动专属卡牌，极高的收藏价值。圣诞老人的特种坐骑，善良纯朴，梦想跟圣诞老人一样，在圣诞节能给孩子们送上喜欢的礼物"

    skillValue: string = "豪礼相送 寒霜体质"
