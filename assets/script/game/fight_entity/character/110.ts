...
@RegisterCharacter({ id: "110" })
export class Character extends CharacterMetaState {

    name: string = "大夜明珠·紫"

    AnimationDir: string = "game/fight_entity/character/110"


    AvatarPath: string = "game/texture/frames/hero/110/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/110/spriteFrame"
