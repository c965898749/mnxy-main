...
@RegisterCharacter({ id: "115" })
export class Character extends CharacterMetaState {

    name: string = "小夜明珠·紫"

    AnimationDir: string = "game/fight_entity/character/115"


    AvatarPath: string = "game/texture/frames/hero/115/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/115/spriteFrame"
