...
@RegisterCharacter({ id: "108" })
export class Character extends CharacterMetaState {

    name: string = "孤魂野鬼"

    AnimationDir: string = "game/fight_entity/character/108"


    AvatarPath: string = "game/texture/frames/hero/108/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/108/spriteFrame"
  ...
  AnimationScale: number = 1
   ...
   position = 2
    ...
    introduce: string = "喜欢在夜晚出没的孤魂野鬼，听说它们会吸取路人的精气来增强自己。"
