...
@RegisterCharacter({ id: "113" })
export class Character extends CharacterMetaState {

    name: string = "大夜明珠·红"

    AnimationDir: string = "game/fight_entity/character/113"


    AvatarPath: string = "game/texture/frames/hero/113/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/113/spriteFrame"
