...
@RegisterCharacter({ id: "109" })
export class Character extends CharacterMetaState {

    name: string = "幼年天将"

    AnimationDir: string = "game/fight_entity/character/109"


    AvatarPath: string = "game/texture/frames/hero/109/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/109/spriteFrame"
  ...
  AnimationScale: number = 1
   ...
   position = 2
    ...
    introduce: string = "幼年天将，天庭战力担当，虽年幼却已显露出非凡的战斗天赋。"
