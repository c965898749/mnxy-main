...
@RegisterCharacter({ id: "127" })
export class Character extends CharacterMetaState {

    name: string = "元始天尊"

    AnimationDir: string = "game/fight_entity/character/127"


    AvatarPath: string = "game/texture/frames/hero/127/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/127/spriteFrame"
