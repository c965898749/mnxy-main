...
@RegisterCharacter({ id: "131" })
export class Character extends CharacterMetaState {

    name: string = "东皇太一"

    AnimationDir: string = "game/fight_entity/character/131"


    AvatarPath: string = "game/texture/frames/hero/131/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/131/spriteFrame"
