...
@RegisterCharacter({ id: "10" })
export class Character extends CharacterMetaState {

    name: string = "红鼻子老道"

    AnimationDir: string = "game/fight_entity/character/10"


    AvatarPath: string = "game/texture/frames/hero/10/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/10/spriteFrame"
    ...
    introduce: string = " 在森林里住着一位老道长,因为他的鼻子是红色的,所以大家都叫他红鼻子老道"
