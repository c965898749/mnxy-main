...
@RegisterCharacter({ id: "116" })
export class Character extends CharacterMetaState {

    name: string = "小夜明珠·蓝"

    AnimationDir: string = "game/fight_entity/character/116"


    AvatarPath: string = "game/texture/frames/hero/116/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/116/spriteFrame"
