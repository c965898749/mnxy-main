...
@RegisterCharacter({ id: "105" })
export class Character extends CharacterMetaState {

    name: string = "魂力宝珠"

    AnimationDir: string = "game/fight_entity/character/105"


    AvatarPath: string = "game/texture/frames/hero/105/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/105/spriteFrame"
  ...
  AnimationScale: number = 1
   ...
   position = 2
    ...
    introduce: string = "你要原地起飞吗？来一颗增加999Exp。"
