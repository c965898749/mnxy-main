...
@RegisterCharacter({ id: "11" })
export class Character extends CharacterMetaState {

    name: string = "长胡子仙人"

    AnimationDir: string = "game/fight_entity/character/11"


    AvatarPath: string = "game/texture/frames/hero/11/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/11/spriteFrame"
    ...
    introduce: string = " 在森林里住着一位老仙人,因为他长着长长的胡子,所以大家都叫他长胡子仙人"
