...
@RegisterCharacter({ id: "118" })
export class Character extends CharacterMetaState {

    name: string = "小夜明珠·红"

    AnimationDir: string = "game/fight_entity/character/118"


    AvatarPath: string = "game/texture/frames/hero/118/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/118/spriteFrame"
