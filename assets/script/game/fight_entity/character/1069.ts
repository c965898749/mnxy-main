...
@RegisterCharacter({ id: "1069" })
export class Character extends CharacterMetaState {

    name: string = "天狗"

    AnimationDir: string = "game/fight_entity/character/1069"


    AvatarPath: string = "game/texture/frames/hero/1069/spriteFrame"

    HeaderPath: string = "game/texture/frames/hero/Header/1069/spriteFrame"
  ...
  AnimationScale: number = 1
   ...
   position = 1
    ...
    赛太岁协同 Lv{skillLv}
    与赛太岁在同一队伍时，增加自身{healVal}点生命上限，{healVal2}点攻击，{healVal3}点速度。
    `.replace(/ /ig, "")

    introduce: string = "天狗有吞食太阳与月亮的能力，直到现在仍在流传。"

    skillValue: string = `天兆神火  赛太岁协同`
